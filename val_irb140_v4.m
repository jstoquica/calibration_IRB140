...
%Programa validar a calibração do IRB140 por conjunto de sub-regiões
%%

tic

%% Leitura dataset
path = 'C:\Users\Juan\Documents\rovis_setembro_2020\kinematics_irb140';

file = 'IK-140_error_14_setembro.dat'; %controlar versão dos dataset
...
for it=[2 7 42 47 72 77 92 97] %numero de SR - variavel dinamica
